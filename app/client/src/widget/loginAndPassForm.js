...
export default class LoginAndPassForm {
    ...
    constructor(settings = {}) {
        ...
        commonEventManager.subscribe('changeLang', this._eventChangeFormLang)
    }

    _eventChangeFormLang = (lang) => {
    ...
    getEmail = () => {
        console.log(this._el_login.getValue());
        return this._el_login.getValue();
    }

    getPassword = () => {
        console.log(this._el_password.getValue());
